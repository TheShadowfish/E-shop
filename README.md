...
(образец - в env.sample)

Фикстуры (содержимое базы данных, примеры статей, товаров - в папке data)
